 ...
 * the License.
 */
package com.berg.generator.config.querys;
...
public class PostgreSqlQuery extends AbstractDbQuery {
    ...
    public String tableFieldsSql() {
        return "SELECT A.attname AS name,format_type (A.atttypid,A.atttypmod) AS type,col_description (A.attrelid,A.attnum) AS comment,A.attnotnull AS NULL,\n" +
    ...
    @Override
    public String fieldRequired(){return "NULL";}

    @Override
    public boolean isRequired(ResultSet results)  throws SQLException {
        return "true".equals(results.getString(fieldRequired()));
    }
}

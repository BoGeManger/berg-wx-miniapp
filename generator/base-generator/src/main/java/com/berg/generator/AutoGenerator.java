...
import com.berg.generator.engine.AbstractTemplateEngine;
...
/**
 * 生成文件(完全扩展mybatis-plus-generator,定制化代码生成)
 */
@Data
@Accessors(chain = true)
public class AutoGenerator {
    private static final Logger logger = LoggerFactory.getLogger(com.berg.generator.AutoGenerator.class);
    ...
    public void executeStr() {
        ...
        // 模板引擎初始化执行文件输出
        templateEngine.init(this.pretreatmentConfigBuilder(config)).batchOutputStr().open();
    }
    ...
    public com.berg.generator.AutoGenerator setCfg(InjectionConfig injectionConfig) {

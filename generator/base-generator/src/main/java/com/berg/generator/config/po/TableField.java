...
import com.berg.generator.config.rules.DbColumnType;
import com.berg.generator.config.rules.IColumnType;
...
public class TableField {
    ...
    public com.berg.generator.config.po.TableField setConvert(boolean convert) {
        this.convert = convert;
        return this;
    }

    protected com.berg.generator.config.po.TableField setConvert(StrategyConfig strategyConfig) {
    ...
    public com.berg.generator.config.po.TableField setPropertyName(StrategyConfig strategyConfig, String propertyName) {

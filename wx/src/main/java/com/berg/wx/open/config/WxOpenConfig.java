package com.berg.wx.open.config;

import com.berg.wx.open.properties.WxOpenProperties;
import com.berg.wx.open.service.WxOpenMessageRouterService;
import com.berg.wx.open.utils.WxOpenUtil;
...
public class WxOpenConfig {
    ...
    public void init() throws Exception{
        ...
        if (configs == null) {
            throw new WxErrorException("微信开放平台配置为空");
        }

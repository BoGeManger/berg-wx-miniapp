package com.berg.wx.pay.config;

import com.berg.wx.pay.properties.WxPayProperties;
import com.berg.wx.pay.utils.WxPayUtil;
...
public class WxPayConfig {
    ...
    public void init() throws Exception{
        ...
        if (configs == null) {
            throw new WxErrorException("微信支付配置为空");
        }
